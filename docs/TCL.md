...
get_nets											- finds the nets under the conditions specified
show_schematic [get_nets txd_tx]					- shows a schematic containing the nets specified
...
get_methodology_violations 	Get a list of Methodology violations from a previous report_methodology run
...
Restart the simulation -- This restarts the simulation at time t=0 without exiting the simulation. You may want to run this command if you want to start the simulation over without relaunching the simulation tool.
```
restart
```
